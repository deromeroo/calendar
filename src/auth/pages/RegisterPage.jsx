        ...
        <div className="flex flex-col gap-6">
            ...
            <form className="space-y-1 md:space-y-6" action="#">
                <div>
                    ...
                    <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-md focus:outline-indigo-400 block w-full p-1" placeholder="Your name" required=""/>
                </div>
                <div>
                    <label htmlFor="email" className="block mb-2 text-md text-indigo-600">Email</label>
                    <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-md  focus:outline-indigo-400 block w-full p-1" placeholder="email@email.com" required=""/>
                </div>
                <div>
                    <label htmlFor="password" className="block mb-2 text-md font-medium text-indigo-600">Password</label>
                    <input type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-600 sm:text-sm rounded-md focus:outline-indigo-400 block w-full p-1" required=""/>
                </div>
